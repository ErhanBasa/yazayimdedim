# Django settings for yazayimdedim project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'yazayimdedim.db',  # Or path to database file if using sqlite3.
...
CKEDITOR_UPLOAD_PATH = os.path.join(PROJECT_DIR, 'uploads/ckeditor')
